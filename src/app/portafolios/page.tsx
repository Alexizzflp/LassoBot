    ...
    <div className="bg-[#070b14] text-slate-50 font-[system-ui] flex-1 flex flex-col h-full">
      ...
      <main className="flex-1 flex items-center justify-center px-4">
        <div className="text-center max-w-lg mx-auto animate-fade-in">
          <div className="w-24 h-24 mx-auto mb-8 rounded-3xl bg-gradient-to-br from-emerald-500/20 to-teal-500/20 border border-emerald-500/30 flex items-center justify-center">
          ...
          <p className="text-sm text-slate-400 leading-relaxed mb-8">
            Organización y gestión de portafolios académicos digitales para tus proyectos y asignaturas universitarias. Este módulo estará disponible en una próxima actualización.
          </p>
          <Link
            href="/"
      ...
      <HelpTooltip 
        moduleId="portafolios"
        title="Módulo de Portafolios"
        description="Próximamente: Organiza tus proyectos y asignaturas en un portafolio digital inteligente."
      />
    </div>
  );
}
